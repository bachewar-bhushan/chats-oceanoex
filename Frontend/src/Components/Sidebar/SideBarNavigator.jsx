...
const SideBarNavigator = () => {
  ...
  return (
    <>
      <div className="flex flex-row space-x-4 w-[100vw] md:w-[20vw] bg-slate-200 justify-center h-[6vh]">
        <div className="flex items-center space-x-6 ">
          <div
            onClick={handleChatClick}
            className={`cursor-pointer ${chatIndicator} h-[5.6vh]`}
          >
            <svg
            className="size-[5vh]"
          ...
          <div
            ...
            className={`cursor-pointer ${groupIndicator} h-[5.6vh]`}
          >
            <svg
              className="size-[5vh]"
              fill="#000000"
            ...
            >
              <g>
                <path
                  d="M34.801,33.099c6.73,0,10.252-9.981,10.252-15.332c0-6.3-4.6-11.426-10.252-11.426c-5.654,0-10.255,5.126-10.255,11.426
		...
		c-3.455,0-6.254-7.232-6.254-11.332C28.547,13.665,31.346,10.341,34.801,10.341z"
                />
                <path
                  d="M45.1,40.093c-0.695-0.498-1.514-0.721-2.334-0.721c-0.745,0-1.492,0.224-2.148,0.642c-1.77,1.129-3.781,1.732-5.818,1.732
		...
		c2.906,0,5.627-0.859,7.967-2.35c3.955,2.84,6.57,10.3,6.57,16.3H20.263z"
                />
                <path
                  d="M30.92,47.391c-0.606-0.244-1.203-0.553-1.771-0.915c-0.345-0.22-0.789-0.208-1.121,0.031
		...
		c0.486,0.273,0.984,0.515,1.49,0.719c0.514,0.205,1.096-0.041,1.302-0.554S31.433,47.598,30.92,47.391z"
                />
                <path
                  d="M34.799,48.146c-0.335,0-0.666-0.018-0.994-0.048c-0.55-0.054-1.037,0.354-1.088,0.904s0.354,1.037,0.904,1.088
		c0.389,0.036,0.781,0.056,1.178,0.056c0.552,0,1-0.447,1-1S35.351,48.146,34.799,48.146z"
                />
                <path
                  d="M57.867,40.813c-0.57-0.33-1.323-0.335-1.919-0.054c-0.261,0.123-1.244,0.375-1.772,0.51
		...
		c-1.104,0-2,0.896-2,2s0.896,2,2,2h7.794c1.104,0,2-0.649,2-1.754C66.867,54.111,63.361,44.01,57.867,40.813z"
                />
                <path
                  d="M16.715,44.318c0.388-1.034-0.136-2.194-1.17-2.582c-0.127-0.048-0.212-0.127-0.438-0.305
		...
		c0.262,0.174,0.581,0.597,0.982,0.747C15.175,45.881,16.326,45.353,16.715,44.318z"
                />
                <path
                  d="M19.706,36.096c0.199,0.025,0.422,0.039,0.661,0.039c1.701,0,4.289-0.72,6.104-3.442c0.613-0.919,0.364-2.161-0.555-2.773
		...
		c-4.55,0-8.252,4.229-8.252,9.426C11.614,27.417,14.682,35.918,19.706,36.096z"
                />
                <path
                  d="M43.506,29.919c-0.92,0.612-1.168,1.854-0.555,2.773c1.814,2.724,4.402,3.442,6.104,3.442c0.24,0,0.463-0.014,0.662-0.039
