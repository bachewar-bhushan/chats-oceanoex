...
const ChattingSpace = () => {
  ...
  return (
    <ScrollToBottom className="bg-slate-100 w-[100vw] md:w-[80vw] h-[79vh] md:h-[70vh] scrollbar-thin  scrollbar-thumb-slate-300 scrollbar-track-slate-200 overflow-y-auto ">
      {messages &&
